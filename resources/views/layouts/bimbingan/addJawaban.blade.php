                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="pt-column" class="form-control"
                                                placeholder="misal Bab 1" name="nama_tugas" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="deskripsi_tugas" placeholder="Jelaskan Tugas Yang Antum Berikan" rows="5" required></textarea>
                                        </div>
                                    </div>
