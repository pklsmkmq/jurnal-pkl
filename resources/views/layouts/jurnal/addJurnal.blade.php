                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="tanggal_jurnal" type="date" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="deskripsi_jurnal" placeholder="Apa yang antum kerjakan hari ini?" required></textarea>
                                        </div>
                                    </div>
